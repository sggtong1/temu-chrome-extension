...
| `scrape:sales-30d` | 全托 `/mms/venom/api/supplier/sales/management/listOverall`(销售管理页,含库存);半托 `/api/sale/analysis/detail`(数据中心商品数据页,按SKU×日销量,无库存)| shop_sku_snapshot |
